...
from src import netvoronoi as nv
import random
random.seed(10)
"""
...
class NetworkVoronoi_Tester(unittest.TestCase):
    ...
    def setUp(self):
        self.net = '../../data/streets.shp'
        self.events = '../../data/crimes.shp'
        
    def test_network_vornoi(self):
        nv.netvoronoi(self.net, self.events, "./netvoronoi_no_wgt.shp","ID_test")
        
    def test_network_vornoi_add_wgt(self):
        #test with additive weight
        nv.netvoronoi(self.net, self.events, './netvoronoi_add_wgt.shp', 'ID_test','add_wgt')
        
    def test_network_vornoi_mul_wgt(self):
        #test with multiplicative weight
        nv.netvoronoi(self.net, self.events, './netvoronoi_mul_wgt.shp', 'ID_test',None,'mul_wgt')
        
    def test_network_vornoi_all_wgts(self):
        #test with both weights
        nv.netvoronoi(self.net, self.events, './netvoronoi_all_wgts.shp', 'ID_test','add_wgt','mul_wgt')
